/*
   ...
   golyoscsapagy.ui.format.graphviz.GraphVizHelper
...
public class GraphVizHelper {
    ...
    private static final String DEFAULT_LOCATION_DOT_WIN64 =
            "/program files (x86)/graphviz2.30/bin/dot.exe";
    ...
    /**
     * Creates a wrapped label for GraphViz nodes. After it performs 
     * the wrapping, it replaces the newline with the appropriate escaped 
     * stuff such that it will appear fine when set for the label 
     * 
     * @param originalLabel
     * @param wrapWidth
     * @return
