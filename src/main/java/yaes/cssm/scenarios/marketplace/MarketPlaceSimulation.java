...
public class MarketPlaceSimulation implements ISimulationCode, Constants, IDetailLevel {
	...
	public void setup(SimulationInput sip, SimulationOutput sop, IContext theContext) {
    	MarketPlaceContext context = (MarketPlaceContext) theContext;
...
//		}
    ...
    public String toString() {
        return "Check point " + MarketPlaceSimulation.simulationLabel;
    }
}
