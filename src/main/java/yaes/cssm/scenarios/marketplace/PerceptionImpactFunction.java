...
//        double oldValue = valueSource.getBeliefValue("SergeantBob", new ConcreteBelief(MARKET_PLACE, POSES_A_THREAT,
...
//     * @return
//     */
//    public double getThreatImpact(List<Double> values, IValueSource valueSource, String agentName) {
//        double PeerPolitenessValue =  valueSource.getCSSMValue("SergeantBob", new CSSM(MARKET_PLACE, POLITENESS, SERGEANT, VENDOR, SERGEANT,
//				0, 100, 50));
//        double oldValue = valueSource.getBeliefValue("SergeantBob", new ConcreteBelief(MARKET_PLACE, POSES_A_THREAT,
//				SERGEANT, SERGEANT, 0, 1.0, 0));
//        MassFunction<Character> m_transaction = massFunctions.get(POSES_A_THREAT);
...
//        	  	m_evidence.add(new Hypothesis<Character>('t'), 0.5);
//        	  	m_evidence.add(new Hypothesis<Character>('n'), 0.3);
//        	}
//        	if(PeerPolitenessValue > 50){
//        	  	m_evidence.add(new Hypothesis<Character>('t'), 0.4);
//	         	m_evidence.add(new Hypothesis<Character>('n', 't'), 0.6);
//        	}
////	            break;
//        }
//			break;
...
//     * @param values
//     * @param valueSource
//     * @param friendName = e.g VendorHussan
//     * @return
//     */
//    public double getFriendImpact(List<Double> values, IValueSource valueSource, String friendName) {
//        double oldValue =  valueSource.getBeliefValue("VendorHassan", new ConcreteBelief(MARKET_PLACE, IS_A_FRIEND,
...
//        case FRIEND_11: {
//            // the overnight delay
//    		double oldDignityValue =  valueSource.getCSSMValue("VendorHassan", new CSSM(MARKET_PLACE, DIGNITY, VENDOR, VENDOR, VENDOR, 0, 100,
//    				50));
//    		double oldPolitenessValue =  valueSource.getCSSMValue("VendorHassan", new CSSM(MARKET_PLACE, POLITENESS, VENDOR, SERGEANT, VENDOR, 0,
//    				100, 50));
//
...
//        case FRIEND_8:
//        case FRIEND_11:
//            return getFriendImpact(values, valueSource, agentName);
//
//        case THREAT_2:
//           return getThreatImpact(values, valueSource, agentName);
//       }
//       return 0;
//	}
