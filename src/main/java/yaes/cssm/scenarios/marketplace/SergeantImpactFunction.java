...
//		//Lx^2
//		case SECURITY_A2:	
//			return ImpactFunctionHelper.Signum(5-MitigatedSpeech) + MitigatedSpeech;
//		
//		//-10 * x * y where x is loudness and y is 
//		case DIGNITY_A2:
//			return -1 * CanonicalImpactFunctions.Heaviside(MitigatedSpeech-2) * Math.exp(MitigatedSpeech/3); 
//			
//		// Order to move
...
//			return ImpactFunctionHelper.Signum(2-MitigatedSpeech) * (Math.abs(2-MitigatedSpeech) + ImpactFunctionHelper.Signum(2-MitigatedSpeech)/(loudness+offensiveness));
//
//			//Declines to move
...
//		
//		case DIGNITY_A11:
//			double oldValue =  valueSource.getCSSMValue("SergeantBob", new CSSM(MARKET_PLACE, DIGNITY, SERGEANT, SERGEANT, SERGEANT, 0,
//					100, 50));
//			if(values.get(0) > 24 && (agentName.equals("VendorHassan") || agentName.equals("VendorAslam") || agentName.equals("VendorAli")))
//					return 50 - oldValue;
//			return 0;
//		case POLITENESS_PEER_A11:
//			double old_Value =  valueSource.getCSSMValue("SergeantBob", new CSSM(MARKET_PLACE, POLITENESS, SERGEANT, VENDOR, SERGEANT,
//					0, 100, 50));
//			if(values.get(0) > 24 &&  (agentName.equals("VendorHassan") || agentName.equals("VendorAslam") || agentName.equals("VendorAli")))
//					return 50 - old_Value;
//			return 0;
